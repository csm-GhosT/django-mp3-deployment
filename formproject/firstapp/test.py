...
RETRAINED_LABELS_TXT_FILE_LOC = \
    os.getcwd() + "/" + "retrained_labels.txt"
RETRAINED_GRAPH_PB_FILE_LOC = os.getcwd() + "/" + "retrained_graph.pb"

TEST_IMAGES_DIR = os.path.join(os.getcwd(),"media")
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            for prediction in sortedPredictions:
                ...
                if onMostLikelyPrediction:
                    ...
                    # f.write("the object appears to be a " + strClassification + ", " + "{0:.2f}".format(scoreAsAPercent) + "% confidence \n")
